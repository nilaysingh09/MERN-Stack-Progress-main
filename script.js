document.addEventListener("DOMContentLoaded", function () {
    ...
    function createStar() {
        ...
        star.style.width = `${isShootingStar ? getRandomNumber(3, 5) : getRandomNumber(3, 4)}px`; // Larger width for shooting stars
        star.style.height = `${isShootingStar ? getRandomNumber(3, 5) : getRandomNumber(3, 4)}px`; // Larger height for shooting stars
